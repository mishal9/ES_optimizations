...
One more thing: when we don’t need data in realtime, but can afford waiting a bit, we can cut our cluster a little slack by raising the indices refresh interval.
